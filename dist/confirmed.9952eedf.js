...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"confirmed.js":[function(require,module,exports) {
window.addEventListener('load', function () {
  ...
  var data1 = window.localStorage.getItem('barber');
  document.getElementById('barber').innerHTML = data1;
  var data2 = window.localStorage.getItem('service');
  document.getElementById('service').innerHTML = data2;
  var data3 = window.localStorage.getItem('calendar');
  document.getElementById('calendar').innerHTML = data3;
  var data4 = window.localStorage.getItem('time');
  document.getElementById('time').innerHTML = data4;
  var data5 = window.localStorage.getItem('barbertest');
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","confirmed.js"], null)
//# sourceMappingURL=/confirmed.9952eedf.js.map